...
const generateCastMaps = (params) => {
    ...
    const literalToScalarMapping = (0, genutil_1.getLiteralToScalarMapping)(gelVersion);
  ...
  return _b != null ? _b : false;
    ...
    f.writeln([(0, builders_1.t) `  ? gel.Range<T['__element__']['__tstype__']>`]);
    f.writeln([(0, builders_1.t) `  : T extends $.MultiRangeType`]);
    f.writeln([(0, builders_1.t) `  ? gel.MultiRange<T['__element__']['__tstype__']>`]);
    f.writeln([(0, builders_1.t) `  : never;`]);
    f.writeln([
        (0, builders_1.t) `export `,
        (0, builders_1.dts) `declare `,
...
>;`,
    ...
    f.writeln([
        (0, builders_1.t) `  T extends gel.Range<infer E> ? $.RangeType<literalToScalarType<E>> :`,
    ]);
    f.writeln([
        (0, builders_1.t) `  T extends gel.MultiRange<infer E> ? $.MultiRangeType<literalToScalarType<E>> :`,
    ]);
