...
const strictMap_1 = require("gel/dist/reflection/strictMap");
const genutil = __importStar(require("./genutil"));
const importExportHelpers_1 = require("./importExportHelpers");
const { exists, readFileUtf8 } = gel_1.systemUtils;
...
class CodeBuilder {
    ...
    resolveIdentRef(identRef, importsExports) {
        ...
        if (ref.dir !== this.dir) {
            ...
            let importPath = node_path_1.default.posix.join(node_path_1.default.posix.relative(node_path_1.default.posix.dirname(this.dir), node_path_1.default.posix.dirname(ref.dir)), moduleFileName);
...
class DirBuilder {
    ...
    async write(to, params, headerComment = "") {
        const dir = node_path_1.default.normalize(to);
        for (const [fn, builder] of this._map.entries()) {
            if (builder.isEmpty()) {
                continue;
            }
            const dest = node_path_1.default.join(dir, fn);
            ...
            if (oldContents !== newContents) {
                await node_fs_1.promises.writeFile(filePath, newContents);
            }
        }
    }
}
